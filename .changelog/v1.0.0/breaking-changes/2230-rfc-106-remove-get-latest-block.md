- `[proto]` Remove stateful block data retrieval methods from the
  ...
  [RFC 106](https://github.com/cometbft/cometbft/blob/v2.x/docs/references/rfc/rfc-106-separate-stateful-methods.md)
...
- `[rpc/grpc]` Remove support for stateful block data retrieval methods from the
  data companion APIs as per [RFC 106](https://github.com/cometbft/cometbft/blob/v2.x/docs/references/rfc/rfc-106-separate-stateful-methods.md)
