...
- `[node]` `BootstrapState` returns an error instead of panicking when the blockstore database cannot be opened
  ([\#6075](https://github.com/cometbft/cometbft/pull/6075))
