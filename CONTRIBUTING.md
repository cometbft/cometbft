...
3. Make sure that your pull request addresses a particular issue and that its description starts with 
the issue number: If it fully closes the issue, please start with "Closes #XXX" (where "XXX" is the issue number), otherwise "Partially closes #XXX", "Addresses #XXX" should be used. 
