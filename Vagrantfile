...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    echo 'cd go/src/github.com/cometbft/cometbft' >> /home/vagrant/.bash_profile

    mkdir -p /home/vagrant/go/bin
    mkdir -p /home/vagrant/go/src/github.com/cometbft
    ln -s /vagrant /home/vagrant/go/src/github.com/cometbft/cometbft
    ...
    su - vagrant -c 'cd /home/vagrant/go/src/github.com/cometbft/cometbft && make tools'
  SHELL
end
