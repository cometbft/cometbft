...
// Client is an autogenerated mock type for the Client interface.
// It provides mock implementations of all ABCI client methods for testing purposes.
type Client struct {
	mock.Mock
}
...
// NewClient creates a new instance of Client mock. It also registers a testing interface on the mock
// and a cleanup function to assert the mocks expectations. The cleanup function will automatically
// verify that all expected method calls were made during test execution.
