...
const (
	ResponseValidateOracleVotes_present ResponseValidateOracleVotes_Status = 0
	ResponseValidateOracleVotes_absent  ResponseValidateOracleVotes_Status = 1
)
...
type Request_SignGossipVote struct {
	SignGossipVote *RequestSignGossipVote `protobuf:"bytes,21,opt,name=sign_gossip_vote,json=signGossipVote,proto3,oneof" json:"sign_gossip_vote,omitempty"`
}
type Request_PrepareOracleVotes struct {
	PrepareOracleVotes *RequestPrepareOracleVotes `protobuf:"bytes,22,opt,name=prepare_oracle_votes,json=prepareOracleVotes,proto3,oneof" json:"prepare_oracle_votes,omitempty"`
}
...
func (*Request_SignGossipVote) isRequest_Value()      {}
func (*Request_PrepareOracleVotes) isRequest_Value()  {}
...
func (m *Request) GetSignGossipVote() *RequestSignGossipVote {
	if x, ok := m.GetValue().(*Request_SignGossipVote); ok {
		return x.SignGossipVote
	}
	return nil
}

func (m *Request) GetPrepareOracleVotes() *RequestPrepareOracleVotes {
	if x, ok := m.GetValue().(*Request_PrepareOracleVotes); ok {
		return x.PrepareOracleVotes
	}
	return nil
}
...
func (*Request) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Request_SignGossipVote)(nil),
		(*Request_PrepareOracleVotes)(nil),
...
type RequestSignGossipVote struct {
	...
	GossipVotes     []*oracle.GossipVote `protobuf:"bytes,2,rep,name=gossip_votes,json=gossipVotes,proto3" json:"gossip_votes,omitempty"`
	Height          int64                `protobuf:"varint,3,opt,name=height,proto3" json:"height,omitempty"`
}

func (m *RequestSignGossipVote) Reset()         { *m = RequestSignGossipVote{} }
func (m *RequestSignGossipVote) String() string { return proto.CompactTextString(m) }
func (*RequestSignGossipVote) ProtoMessage()    {}
func (*RequestSignGossipVote) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{17}
}
func (m *RequestSignGossipVote) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RequestSignGossipVote) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RequestSignGossipVote.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RequestSignGossipVote) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestSignGossipVote.Merge(m, src)
}
func (m *RequestSignGossipVote) XXX_Size() int {
	return m.Size()
}
func (m *RequestSignGossipVote) XXX_DiscardUnknown() {
	xxx_messageInfo_RequestSignGossipVote.DiscardUnknown(m)
}

var xxx_messageInfo_RequestSignGossipVote proto.InternalMessageInfo

func (m *RequestSignGossipVote) GetProposerAddress() []byte {
	if m != nil {
		return m.ProposerAddress
	}
	return nil
...
func (m *RequestSignGossipVote) GetGossipVotes() []*oracle.GossipVote {
	if m != nil {
...
func (m *RequestSignGossipVote) GetHeight() int64 {
	if m != nil {
		return m.Height
	}
	return 0
...
type RequestPrepareOracleVotes struct {
}

func (m *RequestPrepareOracleVotes) Reset()         { *m = RequestPrepareOracleVotes{} }
func (m *RequestPrepareOracleVotes) String() string { return proto.CompactTextString(m) }
func (*RequestPrepareOracleVotes) ProtoMessage()    {}
func (*RequestPrepareOracleVotes) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{18}
}
func (m *RequestPrepareOracleVotes) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RequestPrepareOracleVotes) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RequestPrepareOracleVotes.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RequestPrepareOracleVotes) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestPrepareOracleVotes.Merge(m, src)
}
func (m *RequestPrepareOracleVotes) XXX_Size() int {
	return m.Size()
}
func (m *RequestPrepareOracleVotes) XXX_DiscardUnknown() {
	xxx_messageInfo_RequestPrepareOracleVotes.DiscardUnknown(m)
}

var xxx_messageInfo_RequestPrepareOracleVotes proto.InternalMessageInfo
...
type Response struct {
	...
	//	*Response_SignGossipVote
	//	*Response_PrepareOracleVotes
...
type Response_SignGossipVote struct {
	SignGossipVote *ResponseSignGossipVote `protobuf:"bytes,22,opt,name=sign_gossip_vote,json=signGossipVote,proto3,oneof" json:"sign_gossip_vote,omitempty"`
}
type Response_PrepareOracleVotes struct {
	PrepareOracleVotes *ResponsePrepareOracleVotes `protobuf:"bytes,23,opt,name=prepare_oracle_votes,json=prepareOracleVotes,proto3,oneof" json:"prepare_oracle_votes,omitempty"`
}
...
func (*Response_SignGossipVote) isResponse_Value()      {}
func (*Response_PrepareOracleVotes) isResponse_Value()  {}
...
func (m *Response) GetSignGossipVote() *ResponseSignGossipVote {
	if x, ok := m.GetValue().(*Response_SignGossipVote); ok {
		return x.SignGossipVote
	}
	return nil
}

func (m *Response) GetPrepareOracleVotes() *ResponsePrepareOracleVotes {
	if x, ok := m.GetValue().(*Response_PrepareOracleVotes); ok {
		return x.PrepareOracleVotes
	}
	return nil
}
...
func (*Response) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Response_SignGossipVote)(nil),
		(*Response_PrepareOracleVotes)(nil),
...
type ResponseSignGossipVote struct {
	EncodedTx []byte `protobuf:"bytes,1,opt,name=encoded_tx,json=encodedTx,proto3" json:"encoded_tx,omitempty"`
}

func (m *ResponseSignGossipVote) Reset()         { *m = ResponseSignGossipVote{} }
func (m *ResponseSignGossipVote) String() string { return proto.CompactTextString(m) }
func (*ResponseSignGossipVote) ProtoMessage()    {}
func (*ResponseSignGossipVote) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{38}
}
func (m *ResponseSignGossipVote) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ResponseSignGossipVote) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ResponseSignGossipVote.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ResponseSignGossipVote) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResponseSignGossipVote.Merge(m, src)
}
func (m *ResponseSignGossipVote) XXX_Size() int {
	return m.Size()
}
func (m *ResponseSignGossipVote) XXX_DiscardUnknown() {
	xxx_messageInfo_ResponseSignGossipVote.DiscardUnknown(m)
}

var xxx_messageInfo_ResponseSignGossipVote proto.InternalMessageInfo

func (m *ResponseSignGossipVote) GetEncodedTx() []byte {
	if m != nil {
		return m.EncodedTx
	}
	return nil
...
type ResponsePrepareOracleVotes struct {
	Votes []Vote `protobuf:"bytes,1,rep,name=votes,proto3" json:"votes"`
}

func (m *ResponsePrepareOracleVotes) Reset()         { *m = ResponsePrepareOracleVotes{} }
func (m *ResponsePrepareOracleVotes) String() string { return proto.CompactTextString(m) }
func (*ResponsePrepareOracleVotes) ProtoMessage()    {}
func (*ResponsePrepareOracleVotes) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{40}
}
func (m *ResponsePrepareOracleVotes) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ResponsePrepareOracleVotes) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ResponsePrepareOracleVotes.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ResponsePrepareOracleVotes) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResponsePrepareOracleVotes.Merge(m, src)
}
func (m *ResponsePrepareOracleVotes) XXX_Size() int {
	return m.Size()
}
func (m *ResponsePrepareOracleVotes) XXX_DiscardUnknown() {
	xxx_messageInfo_ResponsePrepareOracleVotes.DiscardUnknown(m)
}

var xxx_messageInfo_ResponsePrepareOracleVotes proto.InternalMessageInfo

func (m *ResponsePrepareOracleVotes) GetVotes() []Vote {
	if m != nil {
		return m.Votes
	}
	return nil
...
type ResponseValidateOracleVotes struct {
	EncodedOracleTx []byte                             `protobuf:"bytes,1,opt,name=encoded_oracle_tx,json=encodedOracleTx,proto3" json:"encoded_oracle_tx,omitempty"`
	Status          ResponseValidateOracleVotes_Status `protobuf:"varint,2,opt,name=status,proto3,enum=tendermint.abci.ResponseValidateOracleVotes_Status" json:"status,omitempty"`
}
...
func (m *ResponseValidateOracleVotes) GetEncodedOracleTx() []byte {
	if m != nil {
		return m.EncodedOracleTx
	}
	return nil
}
...
func (m *ResponseValidateOracleVotes) GetStatus() ResponseValidateOracleVotes_Status {
	...
	return ResponseValidateOracleVotes_present
}
...
func init() {
	...
	proto.RegisterType((*RequestSignGossipVote)(nil), "tendermint.abci.RequestSignGossipVote")
	proto.RegisterType((*RequestPrepareOracleVotes)(nil), "tendermint.abci.RequestPrepareOracleVotes")
	...
	proto.RegisterType((*ResponseSignGossipVote)(nil), "tendermint.abci.ResponseSignGossipVote")
	proto.RegisterType((*Vote)(nil), "tendermint.abci.Vote")
	proto.RegisterType((*ResponsePrepareOracleVotes)(nil), "tendermint.abci.ResponsePrepareOracleVotes")
...
var fileDescriptor_252557cfdd89a31a = []byte{
	...
	,
}
...
type ABCIClient interface {
	...
	SignGossipVote(ctx context.Context, in *RequestSignGossipVote, opts ...grpc.CallOption) (*ResponseSignGossipVote, error)
	PrepareOracleVotes(ctx context.Context, in *RequestPrepareOracleVotes, opts ...grpc.CallOption) (*ResponsePrepareOracleVotes, error)
...
func (c *aBCIClient) SignGossipVote(ctx context.Context, in *RequestSignGossipVote, opts ...grpc.CallOption) (*ResponseSignGossipVote, error) {
	out := new(ResponseSignGossipVote)
	err := c.cc.Invoke(ctx, "/tendermint.abci.ABCI/SignGossipVote", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aBCIClient) PrepareOracleVotes(ctx context.Context, in *RequestPrepareOracleVotes, opts ...grpc.CallOption) (*ResponsePrepareOracleVotes, error) {
	out := new(ResponsePrepareOracleVotes)
	err := c.cc.Invoke(ctx, "/tendermint.abci.ABCI/PrepareOracleVotes", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedABCIServer) SignGossipVote(ctx context.Context, req *RequestSignGossipVote) (*ResponseSignGossipVote, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SignGossipVote not implemented")
}
func (*UnimplementedABCIServer) PrepareOracleVotes(ctx context.Context, req *RequestPrepareOracleVotes) (*ResponsePrepareOracleVotes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PrepareOracleVotes not implemented")
}
...
func _ABCI_SignGossipVote_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestSignGossipVote)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ABCIServer).SignGossipVote(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tendermint.abci.ABCI/SignGossipVote",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ABCIServer).SignGossipVote(ctx, req.(*RequestSignGossipVote))
	}
	return interceptor(ctx, in, info, handler)
}

func _ABCI_PrepareOracleVotes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestPrepareOracleVotes)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ABCIServer).PrepareOracleVotes(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tendermint.abci.ABCI/PrepareOracleVotes",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ABCIServer).PrepareOracleVotes(ctx, req.(*RequestPrepareOracleVotes))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ABCI_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SignGossipVote",
			Handler:    _ABCI_SignGossipVote_Handler,
		},
		{
			MethodName: "PrepareOracleVotes",
			Handler:    _ABCI_PrepareOracleVotes_Handler,
		},
		{
...
func (m *Request_SignGossipVote) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Request_SignGossipVote) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.SignGossipVote != nil {
		{
			size, err := m.SignGossipVote.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Request_PrepareOracleVotes) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Request_PrepareOracleVotes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.PrepareOracleVotes != nil {
		{
			size, err := m.PrepareOracleVotes.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *RequestSignGossipVote) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RequestSignGossipVote) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RequestSignGossipVote) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RequestPrepareOracleVotes) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RequestPrepareOracleVotes) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RequestPrepareOracleVotes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Response_SignGossipVote) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Response_SignGossipVote) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.SignGossipVote != nil {
		{
			size, err := m.SignGossipVote.MarshalToSizedBuffer(dAtA[:i])
...
func (m *Response_PrepareOracleVotes) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Response_PrepareOracleVotes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.PrepareOracleVotes != nil {
		{
			size, err := m.PrepareOracleVotes.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ResponseSignGossipVote) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ResponseSignGossipVote) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ResponseSignGossipVote) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ResponsePrepareOracleVotes) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ResponsePrepareOracleVotes) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ResponsePrepareOracleVotes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ResponseValidateOracleVotes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.EncodedOracleTx) > 0 {
		i -= len(m.EncodedOracleTx)
		copy(dAtA[i:], m.EncodedOracleTx)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.EncodedOracleTx)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Request_SignGossipVote) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.SignGossipVote != nil {
		l = m.SignGossipVote.Size()
		n += 2 + l + sovTypes(uint64(l))
	}
	return n
}
func (m *Request_PrepareOracleVotes) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RequestSignGossipVote) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RequestPrepareOracleVotes) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Response_SignGossipVote) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Response_PrepareOracleVotes) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ResponseSignGossipVote) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ResponsePrepareOracleVotes) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 21:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SignGossipVote", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &RequestSignGossipVote{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &Request_SignGossipVote{v}
			iNdEx = postIndex
		case 22:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrepareOracleVotes", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &RequestPrepareOracleVotes{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &Request_PrepareOracleVotes{v}
			iNdEx = postIndex
		case 23:
			if wireType != 2 {
...
func (m *RequestSignGossipVote) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RequestSignGossipVote: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RequestSignGossipVote: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			m.GossipVotes = append(m.GossipVotes, &oracle.GossipVote{})
...
func (m *RequestPrepareOracleVotes) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RequestPrepareOracleVotes: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RequestPrepareOracleVotes: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *Response) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 22:
			...
			v := &ResponseSignGossipVote{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &Response_SignGossipVote{v}
			iNdEx = postIndex
		case 23:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrepareOracleVotes", wireType)
			...
			v := &ResponsePrepareOracleVotes{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &Response_PrepareOracleVotes{v}
			iNdEx = postIndex
		case 24:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ValidateOracleVotes", wireType)
...
func (m *ResponseSignGossipVote) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ResponseSignGossipVote: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ResponseSignGossipVote: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ResponsePrepareOracleVotes) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ResponsePrepareOracleVotes: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ResponsePrepareOracleVotes: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *ResponseValidateOracleVotes) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EncodedOracleTx", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EncodedOracleTx = append(m.EncodedOracleTx[:0], dAtA[iNdEx:postIndex]...)
			if m.EncodedOracleTx == nil {
				m.EncodedOracleTx = []byte{}
			}
			iNdEx = postIndex
		case 2:
			if wireType != 0 {
