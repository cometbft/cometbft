...
type Request_FetchOracleResults struct {
	FetchOracleResults *RequestFetchOracleResults `protobuf:"bytes,24,opt,name=fetch_oracle_results,json=fetchOracleResults,proto3,oneof" json:"fetch_oracle_results,omitempty"`
}
type Request_DoesSubAccountBelongToVal struct {
	DoesSubAccountBelongToVal *RequestDoesSubAccountBelongToVal `protobuf:"bytes,25,opt,name=does_sub_account_belong_to_val,json=doesSubAccountBelongToVal,proto3,oneof" json:"does_sub_account_belong_to_val,omitempty"`
}
...
func (*Request_FetchOracleResults) isRequest_Value()        {}
...
func (m *Request) GetFetchOracleResults() *RequestFetchOracleResults {
	if x, ok := m.GetValue().(*Request_FetchOracleResults); ok {
		return x.FetchOracleResults
	}
	return nil
}
...
func (*Request) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Request_FetchOracleResults)(nil),
...
type RequestFetchOracleResults struct {
}

func (m *RequestFetchOracleResults) Reset()         { *m = RequestFetchOracleResults{} }
func (m *RequestFetchOracleResults) String() string { return proto.CompactTextString(m) }
func (*RequestFetchOracleResults) ProtoMessage()    {}
func (*RequestFetchOracleResults) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{20}
}
func (m *RequestFetchOracleResults) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RequestFetchOracleResults) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RequestFetchOracleResults.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RequestFetchOracleResults) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestFetchOracleResults.Merge(m, src)
}
func (m *RequestFetchOracleResults) XXX_Size() int {
	return m.Size()
}
func (m *RequestFetchOracleResults) XXX_DiscardUnknown() {
	xxx_messageInfo_RequestFetchOracleResults.DiscardUnknown(m)
}

var xxx_messageInfo_RequestFetchOracleResults proto.InternalMessageInfo
...
type Response_FetchOracleResults struct {
	FetchOracleResults *ResponseFetchOracleResults `protobuf:"bytes,25,opt,name=fetch_oracle_results,json=fetchOracleResults,proto3,oneof" json:"fetch_oracle_results,omitempty"`
}
type Response_DoesSubAccountBelongToVal struct {
	DoesSubAccountBelongToVal *ResponseDoesSubAccountBelongToVal `protobuf:"bytes,26,opt,name=does_sub_account_belong_to_val,json=doesSubAccountBelongToVal,proto3,oneof" json:"does_sub_account_belong_to_val,omitempty"`
}
...
func (*Response_FetchOracleResults) isResponse_Value()        {}
...
func (m *Response) GetFetchOracleResults() *ResponseFetchOracleResults {
	if x, ok := m.GetValue().(*Response_FetchOracleResults); ok {
		return x.FetchOracleResults
	}
	return nil
}
...
func (*Response) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Response_FetchOracleResults)(nil),
...
type ResponseFetchOracleResults struct {
	Results map[string]*EmptyStruct `protobuf:"bytes,1,rep,name=results,proto3" json:"results,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (m *ResponseFetchOracleResults) Reset()         { *m = ResponseFetchOracleResults{} }
func (m *ResponseFetchOracleResults) String() string { return proto.CompactTextString(m) }
func (*ResponseFetchOracleResults) ProtoMessage()    {}
func (*ResponseFetchOracleResults) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{43}
}
func (m *ResponseFetchOracleResults) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ResponseFetchOracleResults) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ResponseFetchOracleResults.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ResponseFetchOracleResults) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResponseFetchOracleResults.Merge(m, src)
}
func (m *ResponseFetchOracleResults) XXX_Size() int {
	return m.Size()
}
func (m *ResponseFetchOracleResults) XXX_DiscardUnknown() {
	xxx_messageInfo_ResponseFetchOracleResults.DiscardUnknown(m)
}

var xxx_messageInfo_ResponseFetchOracleResults proto.InternalMessageInfo

func (m *ResponseFetchOracleResults) GetResults() map[string]*EmptyStruct {
	if m != nil {
		return m.Results
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*RequestFetchOracleResults)(nil), "tendermint.abci.RequestFetchOracleResults")
	...
	proto.RegisterType((*ResponseFetchOracleResults)(nil), "tendermint.abci.ResponseFetchOracleResults")
	proto.RegisterMapType((map[string]*EmptyStruct)(nil), "tendermint.abci.ResponseFetchOracleResults.ResultsEntry")
	proto.RegisterType((*EmptyStruct)(nil), "tendermint.abci.EmptyStruct")
...
var fileDescriptor_252557cfdd89a31a = []byte{
	...
	,
}
...
type ABCIClient interface {
	...
	FetchOracleResults(ctx context.Context, in *RequestFetchOracleResults, opts ...grpc.CallOption) (*ResponseFetchOracleResults, error)
...
func (c *aBCIClient) FetchOracleResults(ctx context.Context, in *RequestFetchOracleResults, opts ...grpc.CallOption) (*ResponseFetchOracleResults, error) {
	out := new(ResponseFetchOracleResults)
	err := c.cc.Invoke(ctx, "/tendermint.abci.ABCI/FetchOracleResults", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedABCIServer) FetchOracleResults(ctx context.Context, req *RequestFetchOracleResults) (*ResponseFetchOracleResults, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FetchOracleResults not implemented")
}
...
func _ABCI_FetchOracleResults_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestFetchOracleResults)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ABCIServer).FetchOracleResults(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tendermint.abci.ABCI/FetchOracleResults",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ABCIServer).FetchOracleResults(ctx, req.(*RequestFetchOracleResults))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ABCI_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FetchOracleResults",
			Handler:    _ABCI_FetchOracleResults_Handler,
		},
		{
...
func (m *Request_FetchOracleResults) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Request_FetchOracleResults) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.FetchOracleResults != nil {
		{
			size, err := m.FetchOracleResults.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *RequestFetchOracleResults) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RequestFetchOracleResults) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RequestFetchOracleResults) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Response_FetchOracleResults) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Response_FetchOracleResults) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.FetchOracleResults != nil {
		{
			size, err := m.FetchOracleResults.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ResponseFetchOracleResults) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ResponseFetchOracleResults) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ResponseFetchOracleResults) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Request_FetchOracleResults) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RequestFetchOracleResults) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Response_FetchOracleResults) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ResponseFetchOracleResults) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 24:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FetchOracleResults", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &RequestFetchOracleResults{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &Request_FetchOracleResults{v}
			iNdEx = postIndex
		case 25:
			if wireType != 2 {
...
func (m *RequestFetchOracleResults) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RequestFetchOracleResults: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RequestFetchOracleResults: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *Response) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 25:
			...
			v := &ResponseFetchOracleResults{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &Response_FetchOracleResults{v}
			iNdEx = postIndex
		case 26:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DoesSubAccountBelongToVal", wireType)
...
func (m *ResponseFetchOracleResults) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ResponseFetchOracleResults: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ResponseFetchOracleResults: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.Results == nil {
				m.Results = make(map[string]*EmptyStruct)
			}
			var mapkey string
			var mapvalue *EmptyStruct
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
