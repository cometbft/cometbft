...
type Request_InsertMempool struct {
	InsertMempool *RequestInsertMempool `protobuf:"bytes,21,opt,name=insert_mempool,json=insertMempool,proto3,oneof" json:"insert_mempool,omitempty"`
}
...
func (*Request_InsertMempool) isRequest_Value()       {}
...
func (m *Request) GetInsertMempool() *RequestInsertMempool {
	if x, ok := m.GetValue().(*Request_InsertMempool); ok {
		return x.InsertMempool
	}
	return nil
}
...
type RequestInsertMempool struct {
	Tx []byte `protobuf:"bytes,1,opt,name=tx,proto3" json:"tx,omitempty"`
}

func (m *RequestInsertMempool) Reset()         { *m = RequestInsertMempool{} }
func (m *RequestInsertMempool) String() string { return proto.CompactTextString(m) }
func (*RequestInsertMempool) ProtoMessage()    {}
func (*RequestInsertMempool) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{17}
}
func (m *RequestInsertMempool) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RequestInsertMempool) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RequestInsertMempool.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RequestInsertMempool) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RequestInsertMempool.Merge(m, src)
}
func (m *RequestInsertMempool) XXX_Size() int {
	return m.Size()
}
func (m *RequestInsertMempool) XXX_DiscardUnknown() {
	xxx_messageInfo_RequestInsertMempool.DiscardUnknown(m)
}

var xxx_messageInfo_RequestInsertMempool proto.InternalMessageInfo

func (m *RequestInsertMempool) GetTx() []byte {
	if m != nil {
		return m.Tx
	}
	return nil
...
type Response_InsertMempool struct {
	InsertMempool *ResponseInsertMempool `protobuf:"bytes,22,opt,name=insert_mempool,json=insertMempool,proto3,oneof" json:"insert_mempool,omitempty"`
}
...
func (*Response_InsertMempool) isResponse_Value()       {}
...
func (m *Response) GetInsertMempool() *ResponseInsertMempool {
	if x, ok := m.GetValue().(*Response_InsertMempool); ok {
		return x.InsertMempool
	}
	return nil
}
...
type ResponseInsertMempool struct {
	Code uint32 `protobuf:"varint,1,opt,name=code,proto3" json:"code,omitempty"`
	Log  string `protobuf:"bytes,2,opt,name=log,proto3" json:"log,omitempty"`
}

func (m *ResponseInsertMempool) Reset()         { *m = ResponseInsertMempool{} }
func (m *ResponseInsertMempool) String() string { return proto.CompactTextString(m) }
func (*ResponseInsertMempool) ProtoMessage()    {}
func (*ResponseInsertMempool) Descriptor() ([]byte, []int) {
	return fileDescriptor_252557cfdd89a31a, []int{36}
}
func (m *ResponseInsertMempool) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ResponseInsertMempool) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ResponseInsertMempool.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ResponseInsertMempool) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResponseInsertMempool.Merge(m, src)
}
func (m *ResponseInsertMempool) XXX_Size() int {
	return m.Size()
}
func (m *ResponseInsertMempool) XXX_DiscardUnknown() {
	xxx_messageInfo_ResponseInsertMempool.DiscardUnknown(m)
}

var xxx_messageInfo_ResponseInsertMempool proto.InternalMessageInfo

func (m *ResponseInsertMempool) GetCode() uint32 {
	if m != nil {
		return m.Code
	}
	return 0
...
func (m *ResponseInsertMempool) GetLog() string {
	if m != nil {
		return m.Log
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*RequestInsertMempool)(nil), "tendermint.abci.RequestInsertMempool")
	...
	proto.RegisterType((*ResponseInsertMempool)(nil), "tendermint.abci.ResponseInsertMempool")
...
var fileDescriptor_252557cfdd89a31a = []byte{
	...
	,
}
...
type ABCIClient interface {
	...
	InsertMempool(ctx context.Context, in *RequestInsertMempool, opts ...grpc.CallOption) (*ResponseInsertMempool, error)
}
...
func (c *aBCIClient) InsertMempool(ctx context.Context, in *RequestInsertMempool, opts ...grpc.CallOption) (*ResponseInsertMempool, error) {
	out := new(ResponseInsertMempool)
	err := c.cc.Invoke(ctx, "/tendermint.abci.ABCI/InsertMempool", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ABCIServer interface {
	...
	InsertMempool(context.Context, *RequestInsertMempool) (*ResponseInsertMempool, error)
}
...
func (*UnimplementedABCIServer) InsertMempool(ctx context.Context, req *RequestInsertMempool) (*ResponseInsertMempool, error) {
	return nil, status.Errorf(codes.Unimplemented, "method InsertMempool not implemented")
}
...
func _ABCI_InsertMempool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestInsertMempool)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ABCIServer).InsertMempool(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tendermint.abci.ABCI/InsertMempool",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ABCIServer).InsertMempool(ctx, req.(*RequestInsertMempool))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ABCI_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "InsertMempool",
			Handler:    _ABCI_InsertMempool_Handler,
		},
	},
...
func (m *Request_InsertMempool) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Request_InsertMempool) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.InsertMempool != nil {
		{
			size, err := m.InsertMempool.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *RequestInsertMempool) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RequestInsertMempool) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RequestInsertMempool) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Response_InsertMempool) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Response_InsertMempool) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.InsertMempool != nil {
		{
			size, err := m.InsertMempool.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ResponseInsertMempool) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ResponseInsertMempool) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ResponseInsertMempool) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Request_InsertMempool) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RequestInsertMempool) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Response_InsertMempool) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ResponseInsertMempool) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 21:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field InsertMempool", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &RequestInsertMempool{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &Request_InsertMempool{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *RequestInsertMempool) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RequestInsertMempool: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RequestInsertMempool: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *Response) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 22:
			...
			v := &ResponseInsertMempool{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Value = &Response_InsertMempool{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *ResponseInsertMempool) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ResponseInsertMempool: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ResponseInsertMempool: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
