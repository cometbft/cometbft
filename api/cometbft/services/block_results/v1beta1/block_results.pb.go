...
type GetBlockResultsResponse struct {
	Height                int64                      `protobuf:"varint,1,opt,name=height,proto3" json:"height,omitempty"`
	TxsResults            []*v1beta3.ExecTxResult    `protobuf:"bytes,2,rep,name=txs_results,json=txsResults,proto3" json:"txs_results,omitempty"`
...
func (m *GetBlockResultsResponse) GetTxsResults() []*v1beta3.ExecTxResult {
	if m != nil {
		return m.TxsResults
	}
	return nil
...
func (m *GetLatestBlockResultsResponse) GetTxsResults() []*v1beta3.ExecTxResult {
	if m != nil {
		return m.TxsResults
	}
	return nil
...
var fileDescriptor_12a641024ad7106e = []byte{
	...
	,
}
...
func (m *GetBlockResultsResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.TxsResults = append(m.TxsResults, &v1beta3.ExecTxResult{})
