...
func init() {
	proto.RegisterFile("cometbft/services/block_results/v2/block_results_service.proto", fileDescriptor_8eb1681fe9761486)
}

var fileDescriptor_8eb1681fe9761486 = []byte{
	...
	,
}
...
func (c *blockResultsServiceClient) GetBlockResults(ctx context.Context, in *GetBlockResultsRequest, opts ...grpc.CallOption) (*GetBlockResultsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cometbft.services.block_results.v2.BlockResultsService/GetBlockResults", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BlockResultsService_GetBlockResults_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cometbft.services.block_results.v2.BlockResultsService/GetBlockResults",
	}
...
var _BlockResultsService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "cometbft.services.block_results.v2.BlockResultsService",
	...
	Metadata: "cometbft/services/block_results/v2/block_results_service.proto",
}
