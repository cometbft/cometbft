...
import (
	...
	v1beta11 "github.com/cometbft/cometbft/api/cometbft/state/v1beta1"
	v1beta12 "github.com/cometbft/cometbft/api/cometbft/types/v1beta1"
...
type ResponseEndBlock struct {
	...
	ConsensusParamUpdates *v1beta31.ConsensusParams `protobuf:"bytes,2,opt,name=consensus_param_updates,json=consensusParamUpdates,proto3" json:"consensus_param_updates,omitempty"`
...
func (m *ResponseEndBlock) GetConsensusParamUpdates() *v1beta31.ConsensusParams {
	if m != nil {
...
type ConsensusParamsInfo struct {
	ConsensusParams   v1beta31.ConsensusParams `protobuf:"bytes,1,opt,name=consensus_params,json=consensusParams,proto3" json:"consensus_params"`
...
func (m *ConsensusParamsInfo) GetConsensusParams() v1beta31.ConsensusParams {
	if m != nil {
		return m.ConsensusParams
	}
	return v1beta31.ConsensusParams{}
}
...
type State struct {
	...
	ConsensusParams                  v1beta31.ConsensusParams `protobuf:"bytes,10,opt,name=consensus_params,json=consensusParams,proto3" json:"consensus_params"`
...
func (m *State) GetConsensusParams() v1beta31.ConsensusParams {
	if m != nil {
		return m.ConsensusParams
	}
	return v1beta31.ConsensusParams{}
...
var fileDescriptor_941a8825417feee0 = []byte{
	...
	,
}
