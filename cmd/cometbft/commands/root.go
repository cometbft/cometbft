...
func ParseConfig(cmd *cobra.Command) (*cfg.Config, error) {
	...
	} else if os.Getenv("CMT_HOME") != "" {
		home = os.Getenv("CMT_HOME")
	} else if os.Getenv("TMHOME") != "" {
		// XXX: Deprecated.
		home = os.Getenv("TMHOME")
		logger.Error("Deprecated environment variable TMHOME identified. CMTHOME or CMT_HOME should be used instead.")
	} else {
