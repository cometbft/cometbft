...
func TestConsensusConfig_ValidateBasic(t *testing.T) {
	...
	testcases := map[string]struct {
		...
		"TimeoutRound":                         {func(c *config.ConsensusConfig) { c.TimeoutRound = time.Second }, false},
		"TimeoutRound negative":                {func(c *config.ConsensusConfig) { c.TimeoutRound = -1 }, true},
		"TimeoutRoundDelta":                    {func(c *config.ConsensusConfig) { c.TimeoutRoundDelta = time.Second }, false},
		"TimeoutRoundDelta negative":           {func(c *config.ConsensusConfig) { c.TimeoutRoundDelta = -1 }, true},
