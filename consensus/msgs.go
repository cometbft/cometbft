...
func WALToProto(msg WALMessage) (*cmtcons.WALMessage, error) {
	...
	case msgInfo:
		...
		case *ProposalMessage:
			...
			consMsg = &cmtcons.Proposal{
				Proposal: *pbP,
			}
		case *ProposalPOLMessage:
			pbBits := msg.ProposalPOL.ToProto()
			consMsg = &cmtcons.ProposalPOL{
				Height:           msg.Height,
				ProposalPolRound: msg.ProposalPOLRound,
				ProposalPol:      *pbBits,
			}
		...
		case *VoteMessage:
			...
			consMsg = &cmtcons.Vote{
				Vote: vote,
			}
		case *HasVoteMessage:
			consMsg = &cmtcons.HasVote{
				Height: msg.Height,
				Round:  msg.Round,
				Type:   msg.Type,
				Index:  msg.Index,
