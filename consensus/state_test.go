...
func TestStateProposerSelection2(t *testing.T) {
	...
	for i := int32(0); int(i) < len(vss); i++ {
		...
		rs := cs1.GetRoundState()
		signAddVotes(cs1, types.PrecommitType, nil, rs.ProposalBlockParts.Header(), true, vss[1:]...)
...
func TestStateLockPOLRelock(t *testing.T) {
	...
	*/
	...
	signAddVotes(cs1, types.PrecommitType, propBlockHash, propBlockParts.Header(), true, vs2, vs3)
...
func TestStateLockPOLUnlock(t *testing.T) {
	...
	*/
	...
	signAddVotes(cs1, types.PrecommitType, nil, types.PartSetHeader{}, true, vs2, vs3)
...
func TestStateLockPOLUnlockOnUnknownBlock(t *testing.T) {
	...
	*/
	...
	signAddVotes(cs1, types.PrevoteType, thirdPropBlockHash, thirdPropBlockParts.Header(), false, vs2, vs3, vs4)
