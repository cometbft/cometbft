...
| `/v1/net_info`             | `/net_info`             |                                                        | Gets network information               | The request should be proxied to the full node since the RPC companion database will not store network information                                                                                                                              | yes   |
