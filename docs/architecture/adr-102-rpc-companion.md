...
These endpoints will proxy the request to the full node. Since they are not dependent on data retrieval from the companion database and only submit transactions they should just act as proxies to the full node. This will ensure that clients don't need to implement a routing logic for endpoints
that would not be available in the RPC companion service. The `/broadcast_tx_*` endpoints might need some additional logic for proxying since some of them have different asynchronicity patterns.

| **RPC Companion Endpoint** | **CometBFT Endpoint**   | **Parameters**                                         | **Description**                           | **Notes**                                                                                                                                                                                                                                       | Proxy |
|----------------------------|-------------------------|--------------------------------------------------------|-------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------|
| `/v1/broadcast_evidence`   | `/broadcast_evidence`   | * evidence                                             | Broadcast evidence of the misbehavior     |                                                                                                                                                                                                                                                 | yes   |
...
| `/v1/consensus_state`      | `/consensus_state`      |                                                        | Gets consensus state                      | The consensus state will not be stored in the RPC companion database so it should proxies to the full node                                                                                                                                      | yes   |
| `/v1/dump_consensus_state` | `/dump_consensus_state` |                                                        | Gets the full consensus state             | The consensus state will not be stored in the RPC companion database so it should proxies to the full node                                                                                                                                      | yes   |
