...
| state\_pruning\_service\_block\_retain\_height          | Gauge     |                    | Number of validator set updates returned by the application since process start                                                        |
| state\_pruning\_service\_block\_results\_retain\_height | Gauge     |                    | Number of validator set updates returned by the application since process start                                                        |
| state\_pruning\_service\_tx\_indexer\_retain\_height    | Gauge     |                    | Number of validator set updates returned by the application since process start                                                        |
| state\_pruning\_service\_block\_indexer\_retain\_height | Gauge     |                    | Number of validator set updates returned by the application since process start                                                        |
| state\_application\_block\_retain\_height               | Gauge     |                    | Number of validator set updates returned by the application since process start                                                        |
| state\_block\_store\_base\_height                       | Gauge     |                    | Number of validator set updates returned by the application since process start                                                        |
| state\_abciresults\_base\_height                        | Gauge     |                    | Number of validator set updates returned by the application since process start                                                        |
| state\_tx\_indexer\_base\_height                        | Gauge     |                    | Number of validator set updates returned by the application since process start                                                        |
| state\_block\_indexer\_base\_height                     | Gauge     |                    | Number of validator set updates returned by the application since process start                                                        |
| state\_store\_access\_duration\_seconds                 | Histogram | method             | Number of validator set updates returned by the application since process start                                                        |
| state\_fire\_block\_events\_delay\_seconds              | Gauge     |                    | Number of validator set updates returned by the application since process start                                                        |
