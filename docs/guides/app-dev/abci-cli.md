...
code can be found
[here](https://github.com/cometbft/cometbft/blob/v2.x/abci/example/kvstore/kvstore.go).
...
Golang](https://github.com/cometbft/cometbft/tree/v2.x/abci/server). See the
