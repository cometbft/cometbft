...
For additional information about changes please refer to the [CHANGELOG.md](https://github.com/cometbft/cometbft/blob/v2.x/CHANGELOG.md)
and [UPGRADING.md](https://github.com/cometbft/cometbft/blob/v2.x/UPGRADING.md) documents.

> **NOTE**: It is essential to emphasize that this is a [major version bump](https://github.com/cometbft/cometbft/blob/v2.x/README.md#versioning)
...
CometBFT now makes use of the `cometbft.*` Protobuf definitions under
 [`proto/cometbft`](https://github.com/cometbft/cometbft/tree/v2.x/proto/cometbft).
...
All Go code generated from the `cometbft.*` types is now available under the
   [`api`](https://github.com/cometbft/cometbft/tree/v2.x/api) directory. This directory is also an independently versioned
...
See the CometBFT Protobufs [README](https://github.com/cometbft/cometbft/tree/v2.x/proto#readme) section for more details.
...
into the [internal](https://github.com/cometbft/cometbft/tree/v2.x/internal) directory:
...
Review the official [CHANGELOG](https://github.com/cometbft/cometbft/blob/v2.x/CHANGELOG.md) for detailed information on changes and improvements in `v1.0`.
...
[bft-time]: https://github.com/cometbft/cometbft/blob/v2.x/spec/consensus/bft-time.md
