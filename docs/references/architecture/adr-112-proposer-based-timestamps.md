...
* Evidence validity is determined [either in terms of heights or in terms of time](https://github.com/cometbft/cometbft/blob/v0.39.x/spec/consensus/evidence.md#verification).
...
[`VoteExtensionsEnableHeight`](https://github.com/cometbft/cometbft/blob/v0.39.x/spec/abci/abci++_app_requirements.md#featureparamsvoteextensionsenableheight).
...
The set of [consensus parameters](https://github.com/cometbft/cometbft/blob/v0.39.x/proto/tendermint/types/params.proto#L13)
...
[`VoteExtensionsEnableHeight`](https://github.com/cometbft/cometbft/blob/v0.39.x/spec/abci/abci++_app_requirements.md#abciparamsvoteextensionsenableheight).
...
[bfttime]: https://github.com/cometbft/cometbft/blob/v0.39.x/spec/consensus/bft-time.md
[pbts-spec]: https://github.com/cometbft/cometbft/tree/main/spec/consensus/proposer-based-timestamp/README.md
[original-adr]: https://github.com/cometbft/cometbft/blob/v0.39.x/docs/references/architecture/tendermint-core/adr-071-proposer-based-timestamps.md
