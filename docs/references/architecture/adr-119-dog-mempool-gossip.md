...
[Flood](https://github.com/cometbft/cometbft/blob/v0.39.x/spec/mempool/gossip/flood.md) is the protocol currently used by CometBFT to gossip transactions. If a transaction
...
We start the design section with a general description of how the algorithm works. The protocol is explained in detail in the accompanying [specification](https://github.com/cometbft/cometbft/blob/v0.39.x/spec/mempool/gossip/dog.md).
...
The [specification](https://github.com/cometbft/cometbft/blob/v0.39.x/spec/mempool/gossip/dog.md) of the protocol introduces 3 additional variables.
...
* [FLOOD](https://github.com/cometbft/cometbft/blob/v0.39.x/spec/mempool/gossip/flood.md)
* [DOG Specification](https://github.com/cometbft/cometbft/blob/v0.39.x/spec/mempool/gossip/dog.md).
