...
overlap or conflict with the upcoming introduction of [ABCI++](https://github.com/tendermint/tendermint/blob/main_backup/docs/rfc/rfc-013-abci%2B%2B.md).
...
- [ABCI++](https://github.com/tendermint/tendermint/blob/main_backup/docs/rfc/rfc-013-abci%2B%2B.md)
- [Mempool Discussion](https://github.com/tendermint/tendermint/discussions/6295)
