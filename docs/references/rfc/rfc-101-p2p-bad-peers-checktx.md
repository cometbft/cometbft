...
Currently, the mempool triggers a disconnect from a peer in the case of the following errors:
  ...
  - [Unknown message type](https://github.com/cometbft/cometbft/blob/v0.39.x/mempool/reactor.go#L119)
...
[`MarkBad`](https://github.com/cometbft/cometbft/blob/v0.39.x/spec/p2p/implementation/addressbook.md#bad-peers) routine implemented by the `Switch`.
