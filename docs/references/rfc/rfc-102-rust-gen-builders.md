...
* [ADR 103](https://github.com/cometbft/cometbft/blob/v2.x/docs/references/architecture/adr-103-proto-versioning.md) details the versioning approach as currently
  accepted.
