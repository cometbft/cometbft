...
require (
	...
	github.com/cockroachdb/pebble v0.0.0-20240112000813-0effd2429fca // indirect
...
replace github.com/cometbft/cometbft-db => github.com/faddat/cometbft-db v0.7.1-0.20240115210328-5b165c3bea65
