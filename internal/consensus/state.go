...
func (cs *State) addVote(vote *types.Vote, peerID p2p.ID) (added bool, err error) { //nolint:revive // this should be made into smaller functions but it is quite difficult.
	cs.Logger.Debug(
		"adding vote",
