...
func (_m *Store) LoadFinalizeBlockResponse(height int64) (*v1beta4.FinalizeBlockResponse, error) {
	ret := _m.Called(height)

	var r0 *v1beta4.FinalizeBlockResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(int64) (*v1beta4.FinalizeBlockResponse, error)); ok {
		return rf(height)
	}
	if rf, ok := ret.Get(0).(func(int64) *v1beta4.FinalizeBlockResponse); ok {
		r0 = rf(height)
	} else {
		if ret.Get(0) != nil {
...
func (_m *Store) LoadLastFinalizeBlockResponse(height int64) (*v1beta4.FinalizeBlockResponse, error) {
	ret := _m.Called(height)
...
func (_m *Store) SaveFinalizeBlockResponse(height int64, res *v1beta4.FinalizeBlockResponse) error {
