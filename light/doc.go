...
https://github.com/comet/comet/blob/v0.34.x/spec/light-client/verification/README.md
for details.
...
for usage example.
Or see
https://github.com/comet/comet/blob/v0.34.x/spec/light-client/README.md
for the full spec
*/
package light
