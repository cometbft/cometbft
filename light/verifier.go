...
func VerifyNonAdjacent(
	...
	err := trustedVals.VerifyCommitLightTrusting(trustedHeader.ChainID, untrustedHeader.Commit, trustLevel, false)
	if err != nil {
		switch e := err.(type) {
	...
	if err := untrustedVals.VerifyCommitLight(trustedHeader.ChainID, untrustedHeader.Commit.BlockID,
		untrustedHeader.Height, untrustedHeader.Commit, false); err != nil {
		return ErrInvalidHeader{err}
	}
