...
func (_m *Mempool) Update(blockHeight int64, blockTxs types.Txs, deliverTxResponses []*v1beta3.ExecTxResult, newPreFn mempool.PreCheckFunc, newPostFn mempool.PostCheckFunc) error {
	ret := _m.Called(blockHeight, blockTxs, deliverTxResponses, newPreFn, newPostFn)

	var r0 error
	if rf, ok := ret.Get(0).(func(int64, types.Txs, []*v1beta3.ExecTxResult, mempool.PreCheckFunc, mempool.PostCheckFunc) error); ok {
