...
func (n *Node) OnStart() error {
	...
	if n.stateSync {
		...
		newState, err := startStateSync(n.stateSyncReactor, n.stateSyncProvider,
		...
		case statesync.ErrNoSnapshots:
			n.Logger.Info("no snapshots found. switching to blocksync with genesis state")
