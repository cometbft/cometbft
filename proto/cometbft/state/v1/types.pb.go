...
import (
	...
	v12 "github.com/cometbft/cometbft/proto/cometbft/version/v1"
...
type ABCIResponses struct {
	DeliverTxs []*v1.ResponseDeliverTx `protobuf:"bytes,1,rep,name=deliver_txs,json=deliverTxs,proto3" json:"deliver_txs,omitempty"`
	EndBlock   *v1.ResponseEndBlock    `protobuf:"bytes,2,opt,name=end_block,json=endBlock,proto3" json:"end_block,omitempty"`
	BeginBlock *v1.ResponseBeginBlock  `protobuf:"bytes,3,opt,name=begin_block,json=beginBlock,proto3" json:"begin_block,omitempty"`
}
...
func (m *ABCIResponses) GetDeliverTxs() []*v1.ResponseDeliverTx {
	if m != nil {
		return m.DeliverTxs
	}
	return nil
...
func (m *ABCIResponses) GetEndBlock() *v1.ResponseEndBlock {
	if m != nil {
		return m.EndBlock
	}
	return nil
...
func (m *ABCIResponses) GetBeginBlock() *v1.ResponseBeginBlock {
	if m != nil {
		return m.BeginBlock
	}
	return nil
...
func init() {
	proto.RegisterType((*ABCIResponses)(nil), "cometbft.state.v1.ABCIResponses")
...
var fileDescriptor_eb6b2e03ecdbc0c2 = []byte{
	...
	,
}
...
func (m *ABCIResponses) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.DeliverTxs = append(m.DeliverTxs, &v1.ResponseDeliverTx{})
		...
		case 2:
			...
			if m.EndBlock == nil {
				m.EndBlock = &v1.ResponseEndBlock{}
			}
		...
		case 3:
			...
			if m.BeginBlock == nil {
				m.BeginBlock = &v1.ResponseBeginBlock{}
			}
