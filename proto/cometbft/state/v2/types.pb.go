...
import (
	...
	v21 "github.com/cometbft/cometbft/proto/cometbft/types/v2"
...
type ABCIResponses struct {
	DeliverTxs []*v2.ResponseDeliverTx `protobuf:"bytes,1,rep,name=deliver_txs,json=deliverTxs,proto3" json:"deliver_txs,omitempty"`
	EndBlock   *v2.ResponseEndBlock    `protobuf:"bytes,2,opt,name=end_block,json=endBlock,proto3" json:"end_block,omitempty"`
...
func (m *ABCIResponses) GetDeliverTxs() []*v2.ResponseDeliverTx {
	if m != nil {
		return m.DeliverTxs
	}
	return nil
...
func (m *ABCIResponses) GetEndBlock() *v2.ResponseEndBlock {
	if m != nil {
		return m.EndBlock
	}
	return nil
...
func (m *ABCIResponses) GetBeginBlock() *v2.ResponseBeginBlock {
	if m != nil {
		return m.BeginBlock
	}
	return nil
...
func init() {
	proto.RegisterType((*ABCIResponses)(nil), "cometbft.state.v2.ABCIResponses")
...
var fileDescriptor_c6c696255fbe933e = []byte{
	...
	,
}
...
func (m *ABCIResponses) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.DeliverTxs = append(m.DeliverTxs, &v2.ResponseDeliverTx{})
		...
		case 2:
			...
			if m.EndBlock == nil {
				m.EndBlock = &v2.ResponseEndBlock{}
			}
