...
type Txs struct {
	...
	SeenBy []string `protobuf:"bytes,2,rep,name=seen_by,json=seenBy,proto3" json:"seen_by,omitempty"`
}
...
var fileDescriptor_2af51926fdbcbc05 = []byte{
	...
	,
}
...
func (m *Txs) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.SeenBy) > 0 {
		for iNdEx := len(m.SeenBy) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.SeenBy[iNdEx])
			copy(dAtA[i:], m.SeenBy[iNdEx])
			i = encodeVarintTypes(dAtA, i, uint64(len(m.SeenBy[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *Txs) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SeenBy", wireType)
			}
			...
			m.SeenBy = append(m.SeenBy, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
