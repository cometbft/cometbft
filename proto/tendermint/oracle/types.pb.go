...
type CompressedVote struct {
	Validator []byte `protobuf:"bytes,1,opt,name=validator,proto3" json:"validator,omitempty"`
	OracleId  []byte `protobuf:"bytes,2,opt,name=oracle_id,json=oracleId,proto3" json:"oracle_id,omitempty"`
	Timestamp uint64 `protobuf:"varint,3,opt,name=timestamp,proto3" json:"timestamp,omitempty"`
	Data      []byte `protobuf:"bytes,4,opt,name=data,proto3" json:"data,omitempty"`
}

func (m *CompressedVote) Reset()         { *m = CompressedVote{} }
func (m *CompressedVote) String() string { return proto.CompactTextString(m) }
func (*CompressedVote) ProtoMessage()    {}
func (*CompressedVote) Descriptor() ([]byte, []int) {
	return fileDescriptor_ed9227d272ed5d90, []int{1}
}
func (m *CompressedVote) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CompressedVote) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CompressedVote.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CompressedVote) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CompressedVote.Merge(m, src)
}
func (m *CompressedVote) XXX_Size() int {
	return m.Size()
}
func (m *CompressedVote) XXX_DiscardUnknown() {
	xxx_messageInfo_CompressedVote.DiscardUnknown(m)
}

var xxx_messageInfo_CompressedVote proto.InternalMessageInfo

func (m *CompressedVote) GetValidator() []byte {
	if m != nil {
		return m.Validator
	}
	return nil
...
func (m *CompressedVote) GetOracleId() []byte {
	if m != nil {
		return m.OracleId
	}
	return nil
...
func (m *CompressedVote) GetTimestamp() uint64 {
	if m != nil {
		return m.Timestamp
	}
	return 0
...
func (m *CompressedVote) GetData() []byte {
	if m != nil {
		return m.Data
	}
	return nil
...
type GossipVote struct {
	...
	Votes           []*CompressedVote `protobuf:"bytes,4,rep,name=votes,proto3" json:"votes,omitempty"`
...
func (m *GossipVote) GetVotes() []*CompressedVote {
	if m != nil {
		return m.Votes
	}
	return nil
...
func (m *CanonicalGossipVote) GetVotes() []*CompressedVote {
	if m != nil {
		return m.Votes
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*CompressedVote)(nil), "tendermint.oracle.CompressedVote")
...
var fileDescriptor_ed9227d272ed5d90 = []byte{
	...
	,
}
...
func (m *CompressedVote) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CompressedVote) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CompressedVote) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CompressedVote) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CompressedVote) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CompressedVote: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CompressedVote: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			m.OracleId = append(m.OracleId[:0], dAtA[iNdEx:postIndex]...)
			if m.OracleId == nil {
				m.OracleId = []byte{}
			}
			iNdEx = postIndex
...
func (m *GossipVote) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.Votes = append(m.Votes, &CompressedVote{})
