...
// SignOracleVoteRequest is a request to sign a vote
type SignOracleVoteRequest struct {
	Vote            *oracle.GossipedVotes `protobuf:"bytes,1,opt,name=vote,proto3" json:"vote,omitempty"`
	ChainId         string                `protobuf:"bytes,2,opt,name=chain_id,json=chainId,proto3" json:"chain_id,omitempty"`
	SignaturePrefix []byte                `protobuf:"bytes,3,opt,name=signature_prefix,json=signaturePrefix,proto3" json:"signature_prefix,omitempty"`
}

func (m *SignOracleVoteRequest) Reset()         { *m = SignOracleVoteRequest{} }
func (m *SignOracleVoteRequest) String() string { return proto.CompactTextString(m) }
func (*SignOracleVoteRequest) ProtoMessage()    {}
func (*SignOracleVoteRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_cb4e437a5328cf9c, []int{7}
}
func (m *SignOracleVoteRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SignOracleVoteRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SignOracleVoteRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SignOracleVoteRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SignOracleVoteRequest.Merge(m, src)
}
func (m *SignOracleVoteRequest) XXX_Size() int {
	return m.Size()
}
func (m *SignOracleVoteRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_SignOracleVoteRequest.DiscardUnknown(m)
}

var xxx_messageInfo_SignOracleVoteRequest proto.InternalMessageInfo

func (m *SignOracleVoteRequest) GetVote() *oracle.GossipedVotes {
	if m != nil {
		return m.Vote
	}
	return nil
...
func (m *SignOracleVoteRequest) GetChainId() string {
	if m != nil {
		return m.ChainId
	}
	return ""
...
func (m *SignOracleVoteRequest) GetSignaturePrefix() []byte {
	if m != nil {
		return m.SignaturePrefix
	}
	return nil
}

// SignedOracleVoteResponse is a response containing a signed vote or an error
type SignedOracleVoteResponse struct {
	Vote  oracle.GossipedVotes `protobuf:"bytes,1,opt,name=vote,proto3" json:"vote"`
	Error *RemoteSignerError   `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"`
}

func (m *SignedOracleVoteResponse) Reset()         { *m = SignedOracleVoteResponse{} }
func (m *SignedOracleVoteResponse) String() string { return proto.CompactTextString(m) }
func (*SignedOracleVoteResponse) ProtoMessage()    {}
func (*SignedOracleVoteResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_cb4e437a5328cf9c, []int{8}
}
func (m *SignedOracleVoteResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SignedOracleVoteResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SignedOracleVoteResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SignedOracleVoteResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SignedOracleVoteResponse.Merge(m, src)
}
func (m *SignedOracleVoteResponse) XXX_Size() int {
	return m.Size()
}
func (m *SignedOracleVoteResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_SignedOracleVoteResponse.DiscardUnknown(m)
}

var xxx_messageInfo_SignedOracleVoteResponse proto.InternalMessageInfo

func (m *SignedOracleVoteResponse) GetVote() oracle.GossipedVotes {
	if m != nil {
		return m.Vote
	}
	return oracle.GossipedVotes{}
}

func (m *SignedOracleVoteResponse) GetError() *RemoteSignerError {
	if m != nil {
		return m.Error
	}
	return nil
...
type Message struct {
	...
	//	*Message_SignOracleVoteRequest
	//	*Message_SignedOracleVoteResponse
...
type Message_SignOracleVoteRequest struct {
	SignOracleVoteRequest *SignOracleVoteRequest `protobuf:"bytes,9,opt,name=sign_oracle_vote_request,json=signOracleVoteRequest,proto3,oneof" json:"sign_oracle_vote_request,omitempty"`
}
type Message_SignedOracleVoteResponse struct {
	SignedOracleVoteResponse *SignedOracleVoteResponse `protobuf:"bytes,10,opt,name=signed_oracle_vote_response,json=signedOracleVoteResponse,proto3,oneof" json:"signed_oracle_vote_response,omitempty"`
}
...
func (*Message_SignOracleVoteRequest) isMessage_Sum()    {}
func (*Message_SignedOracleVoteResponse) isMessage_Sum() {}
...
func (m *Message) GetSignOracleVoteRequest() *SignOracleVoteRequest {
	if x, ok := m.GetSum().(*Message_SignOracleVoteRequest); ok {
		return x.SignOracleVoteRequest
	}
	return nil
}

func (m *Message) GetSignedOracleVoteResponse() *SignedOracleVoteResponse {
	if x, ok := m.GetSum().(*Message_SignedOracleVoteResponse); ok {
		return x.SignedOracleVoteResponse
	}
	return nil
}
...
func (*Message) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Message_SignOracleVoteRequest)(nil),
		(*Message_SignedOracleVoteResponse)(nil),
	}
}
...
func init() {
	...
	proto.RegisterType((*SignOracleVoteRequest)(nil), "tendermint.privval.SignOracleVoteRequest")
	proto.RegisterType((*SignedOracleVoteResponse)(nil), "tendermint.privval.SignedOracleVoteResponse")
...
var fileDescriptor_cb4e437a5328cf9c = []byte{
	...
	,
}
...
func (m *SignOracleVoteRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SignOracleVoteRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SignOracleVoteRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.SignaturePrefix) > 0 {
		i -= len(m.SignaturePrefix)
		copy(dAtA[i:], m.SignaturePrefix)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.SignaturePrefix)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.ChainId) > 0 {
...
func (m *SignedOracleVoteResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SignedOracleVoteResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SignedOracleVoteResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Message_SignOracleVoteRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Message_SignOracleVoteRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.SignOracleVoteRequest != nil {
		{
			size, err := m.SignOracleVoteRequest.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Message_SignedOracleVoteResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Message_SignedOracleVoteResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.SignedOracleVoteResponse != nil {
		{
			size, err := m.SignedOracleVoteResponse.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *SignOracleVoteRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *SignedOracleVoteResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Message_SignOracleVoteRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.SignOracleVoteRequest != nil {
		l = m.SignOracleVoteRequest.Size()
		n += 1 + l + sovTypes(uint64(l))
	}
	return n
}
func (m *Message_SignedOracleVoteResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.SignedOracleVoteResponse != nil {
		l = m.SignedOracleVoteResponse.Size()
		n += 1 + l + sovTypes(uint64(l))
	}
	return n
}
...
func (m *SignOracleVoteRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SignOracleVoteRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SignOracleVoteRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SignaturePrefix", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SignaturePrefix = append(m.SignaturePrefix[:0], dAtA[iNdEx:postIndex]...)
			if m.SignaturePrefix == nil {
				m.SignaturePrefix = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *SignedOracleVoteResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SignedOracleVoteResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SignedOracleVoteResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *Message) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SignOracleVoteRequest", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &SignOracleVoteRequest{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Sum = &Message_SignOracleVoteRequest{v}
			iNdEx = postIndex
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SignedOracleVoteResponse", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &SignedOracleVoteResponse{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Sum = &Message_SignedOracleVoteResponse{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
