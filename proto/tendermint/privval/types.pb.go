...
func (m *SignedDigestResponse) GetError() *RemoteSignerError {
	if m != nil {
		return m.Error
	}
	return nil
...
type Message struct {
	...
	//	*Message_SignDigestRequest
	//	*Message_SignedDigestResponse
...
type Message_SignDigestRequest struct {
	SignDigestRequest *SignDigestRequest `protobuf:"bytes,9,opt,name=sign_digest_request,json=signDigestRequest,proto3,oneof" json:"sign_digest_request,omitempty"`
}
type Message_SignedDigestResponse struct {
	SignedDigestResponse *SignedDigestResponse `protobuf:"bytes,10,opt,name=signed_digest_response,json=signedDigestResponse,proto3,oneof" json:"signed_digest_response,omitempty"`
}
...
func (*Message_SignDigestRequest) isMessage_Sum()      {}
func (*Message_SignedDigestResponse) isMessage_Sum()   {}
...
func (m *Message) GetSignDigestRequest() *SignDigestRequest {
	if x, ok := m.GetSum().(*Message_SignDigestRequest); ok {
		return x.SignDigestRequest
	}
	return nil
}

func (m *Message) GetSignedDigestResponse() *SignedDigestResponse {
	if x, ok := m.GetSum().(*Message_SignedDigestResponse); ok {
		return x.SignedDigestResponse
	}
	return nil
}
...
func (*Message) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Message_SignDigestRequest)(nil),
		(*Message_SignedDigestResponse)(nil),
	}
}
...
func init() {
	...
	proto.RegisterType((*SignDigestRequest)(nil), "tendermint.privval.SignDigestRequest")
	proto.RegisterType((*SignedDigestResponse)(nil), "tendermint.privval.SignedDigestResponse")
...
var fileDescriptor_cb4e437a5328cf9c = []byte{
	...
	,
}
...
func (m *Message_SignDigestRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Message_SignDigestRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.SignDigestRequest != nil {
		{
			size, err := m.SignDigestRequest.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Message_SignedDigestResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Message_SignedDigestResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.SignedDigestResponse != nil {
		{
			size, err := m.SignedDigestResponse.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Message_SignDigestRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.SignDigestRequest != nil {
		l = m.SignDigestRequest.Size()
		n += 1 + l + sovTypes(uint64(l))
	}
	return n
}
func (m *Message_SignedDigestResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Message) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SignDigestRequest", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Sum = &Message_SignDigestRequest{v}
			iNdEx = postIndex
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SignedDigestResponse", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &SignedDigestResponse{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Sum = &Message_SignedDigestResponse{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
