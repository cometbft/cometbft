...
type SignOracleVoteRequest struct {
	Vote    *oracle.GossipVote `protobuf:"bytes,1,opt,name=vote,proto3" json:"vote,omitempty"`
	ChainId string             `protobuf:"bytes,2,opt,name=chain_id,json=chainId,proto3" json:"chain_id,omitempty"`
}
...
func (m *SignOracleVoteRequest) GetVote() *oracle.GossipVote {
	if m != nil {
		return m.Vote
	}
	return nil
...
type SignedOracleVoteResponse struct {
	Vote  oracle.GossipVote  `protobuf:"bytes,1,opt,name=vote,proto3" json:"vote"`
	Error *RemoteSignerError `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"`
}
...
func (m *SignedOracleVoteResponse) GetVote() oracle.GossipVote {
	if m != nil {
		return m.Vote
	}
	return oracle.GossipVote{}
}
...
var fileDescriptor_cb4e437a5328cf9c = []byte{
	...
	,
}
