...
var fileDescriptor_4d6550c091adc944 = []byte{
	...
	0x3a, 0xcc, 0xc4, 0x25, 0xec, 0x04, 0x12, 0x0f, 0x82, 0x08, 0x07, 0x43, 0x74, 0x0b, 0xf5, 0x31,
	...
	0x4e, 0x15, 0x9a, 0xc5, 0xc8, 0x25, 0xea, 0x9e, 0x5a, 0xe2, 0x93, 0x58, 0x92, 0x5a, 0x8c, 0xea,
	0x2c, 0x27, 0xa2, 0x0d, 0xc6, 0xd4, 0x4c, 0x1d, 0xc7, 0x39, 0x25, 0x9e, 0x78, 0x24, 0xc7, 0x78,
	...
	0xae, 0x7e, 0x72, 0x7e, 0x6e, 0x6a, 0x49, 0x52, 0x5a, 0x09, 0x82, 0x01, 0x8e, 0x03, 0x7d, 0x62,
	0x22, 0x2f, 0x89, 0x0d, 0xac, 0xd6, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x91, 0xbc, 0x2a, 0x23,
	0x53, 0x02, 0x00, 0x00,
}
...
func (c *blockResultsServiceClient) GetLatestBlockResults(ctx context.Context, in *GetLatestBlockResultsRequest, opts ...grpc.CallOption) (*GetBlockResultsResponse, error) {
	out := new(GetBlockResultsResponse)
	err := c.cc.Invoke(ctx, "/tendermint.services.block_results.v1.BlockResultsService/GetLatestBlockResults", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BlockResultsService_GetLatestBlockResults_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tendermint.services.block_results.v1.BlockResultsService/GetLatestBlockResults",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
