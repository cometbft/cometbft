...
type PartSetHeader struct {
	...
	// Types that are valid to be assigned to XByteSize:
	//	*PartSetHeader_ByteSize
	XByteSize isPartSetHeader_XByteSize `protobuf_oneof:"_byte_size"`
}
...
type isPartSetHeader_XByteSize interface {
	isPartSetHeader_XByteSize()
	MarshalTo([]byte) (int, error)
	Size() int
}

type PartSetHeader_ByteSize struct {
	ByteSize uint64 `protobuf:"varint,3,opt,name=byte_size,json=byteSize,proto3,oneof" json:"byte_size,omitempty"`
}

func (*PartSetHeader_ByteSize) isPartSetHeader_XByteSize() {}

func (m *PartSetHeader) GetXByteSize() isPartSetHeader_XByteSize {
	if m != nil {
		return m.XByteSize
	}
	return nil
...
func (m *PartSetHeader) GetByteSize() uint64 {
	if x, ok := m.GetXByteSize().(*PartSetHeader_ByteSize); ok {
		return x.ByteSize
	}
	return 0
}
...
type Part struct {
	...
	//	*Part_Index
	XIndex   isPart_XIndex `protobuf_oneof:"_index"`
	Bytes    []byte        `protobuf:"bytes,2,opt,name=bytes,proto3" json:"bytes,omitempty"`
	Proof    crypto.Proof  `protobuf:"bytes,3,opt,name=proof,proto3" json:"proof"`
	IsParity bool          `protobuf:"varint,4,opt,name=is_parity,json=isParity,proto3" json:"is_parity,omitempty"`
}
...
type isPart_XIndex interface {
	isPart_XIndex()
	MarshalTo([]byte) (int, error)
	Size() int
}

type Part_Index struct {
	Index uint32 `protobuf:"fixed32,1,opt,name=index,proto3,oneof" json:"index,omitempty"`
}

func (*Part_Index) isPart_XIndex() {}

func (m *Part) GetXIndex() isPart_XIndex {
	if m != nil {
		return m.XIndex
	}
	return nil
...
func (m *Part) GetIndex() uint32 {
	if x, ok := m.GetXIndex().(*Part_Index); ok {
		return x.Index
	}
	return 0
}
...
var fileDescriptor_d3a6e55e2345de56 = []byte{
	...
	,
}
...
func (m *PartSetHeader) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.XByteSize != nil {
		{
			size := m.XByteSize.Size()
			i -= size
			if _, err := m.XByteSize.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
		}
	}
...
func (m *PartSetHeader_ByteSize) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PartSetHeader_ByteSize) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *Part_Index) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Part_Index) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= 4
...
func (m *PartSetHeader_ByteSize) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *PartSetHeader) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.XByteSize = &PartSetHeader_ByteSize{v}
		default:
			iNdEx = preIndex
