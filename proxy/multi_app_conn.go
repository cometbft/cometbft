...
func (app *multiAppConn) startQueryClient() error {
	...
	if err != nil {
		return ErrABCIClient{Action: "creating", CliType: "query", Err: err}
	}
...
func (app *multiAppConn) startSnapshotClient() error {
	...
	if err != nil {
		return ErrABCIClient{Action: "creating", CliType: "snapshot", Err: err}
	}
...
func (app *multiAppConn) startMempoolClient() error {
	...
	if err != nil {
		return ErrABCIClient{Action: "creating", CliType: "mempool", Err: err}
	}
...
func (app *multiAppConn) startConsensusClient() error {
	...
	if err != nil {
		app.stopAllClients()
		return ErrABCIClient{Action: "creating", CliType: "consensus", Err: err}
	}
...
func (app *multiAppConn) startClient(c abcicli.Client, conn string) error {
	...
	if err := c.Start(); err != nil {
		return ErrABCIClient{Action: "starting", CliType: conn, Err: err}
	}
	return nil
}
