...
Note: There is currently no consensus parameter to enable/disable Proposer-Based Timestamps (PBTS). PBTS behavior is governed by node configuration/algorithm rather than `ConsensusParams`.
