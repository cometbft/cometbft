...
voting power (see
[implementation](https://github.com/cometbft/cometbft/blob/main/types/validator_set.go)).
...
[commit](https://github.com/cometbft/cometbft/blob/main/docs/tendermint-core/validators.md), any 1/3+ coalition of
