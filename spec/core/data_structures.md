...
| Evidence   | [EvidenceList](#evidencelist) | Evidence contains a list of misbehavior committed by validators.                                                                                                                                                                                                                                                                                                                                                                           | Can be empty, but when populated the validations rules from [evidenceList](#evidencelist) apply |
