...
func (_m *Store) LoadFromDBOrGenesisDoc(_a0 *cometbfttypes.GenesisDoc) (state.State, error) {
	ret := _m.Called(_a0)

	var r0 state.State
	if rf, ok := ret.Get(0).(func(*cometbfttypes.GenesisDoc) state.State); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Get(0).(state.State)
	}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(*cometbfttypes.GenesisDoc) error); ok {
		r1 = rf(_a0)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *Store) LoadValidators(_a0 int64) (*cometbfttypes.ValidatorSet, error) {
	ret := _m.Called(_a0)
