...
func (_m *TxIndexer) Get(hash []byte) (*v3.TxResult, error) {
	ret := _m.Called(hash)

	var r0 *v3.TxResult
	var r1 error
	if rf, ok := ret.Get(0).(func([]byte) (*v3.TxResult, error)); ok {
		return rf(hash)
	}
	if rf, ok := ret.Get(0).(func([]byte) *v3.TxResult); ok {
		r0 = rf(hash)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v3.TxResult)
		}
	}
...
func (_m *TxIndexer) Index(result *v3.TxResult) error {
	ret := _m.Called(result)

	var r0 error
	if rf, ok := ret.Get(0).(func(*v3.TxResult) error); ok {
		r0 = rf(result)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *TxIndexer) Search(ctx context.Context, q *query.Query) ([]*v3.TxResult, error) {
	ret := _m.Called(ctx, q)

	var r0 []*v3.TxResult
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *query.Query) ([]*v3.TxResult, error)); ok {
		return rf(ctx, q)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *query.Query) []*v3.TxResult); ok {
		r0 = rf(ctx, q)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*v3.TxResult)
