...
import (
	...
	"github.com/cometbft/cometbft/test/e2e/abci/parser/bsr"
	"github.com/cometbft/cometbft/test/e2e/abci/parser/slot"
	"github.com/cometbft/cometbft/test/e2e/abci/parser/symbols"
	"github.com/cometbft/cometbft/test/e2e/abci/token"
)
...
func (p *parser) parse() (*bsr.Set, []*Error) {
	...
	for !p.R.empty() {
		...
		switch L {
		case slot.ApplyChunk0R0: // ApplyChunk : ∙11
		...
		case slot.BeginBlock0R0: // BeginBlock : ∙3
		...
		case slot.DeliverTx0R0: // DeliverTx : ∙4
		...
		case slot.EndBlock0R0: // EndBlock : ∙5
		...
		case slot.OfferSnapshot0R0: // OfferSnapshot : ∙10
		...
		case slot.PrepareProposal0R0: // PrepareProposal : ∙13
		...
		case slot.ProcessProposal0R0: // ProcessProposal : ∙14
		...
		case slot.SuccessSync1R0: // SuccessSync : ∙OfferSnapshot

			p.call(slot.SuccessSync1R1, cU, p.cI)
		case slot.SuccessSync1R1: // SuccessSync : OfferSnapshot ∙

			if p.follow(symbols.NT_SuccessSync) {
				p.rtn(symbols.NT_SuccessSync, cU, p.cI)
			} else {
				p.parseError(slot.SuccessSync1R0, p.cI, followSets[symbols.NT_SuccessSync])
			}
