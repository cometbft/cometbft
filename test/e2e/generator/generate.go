...
var (
	...
	voteExtensionSize          = uniformChoice{uint(128 / 3), uint(512 / 3), uint(2048 / 3), uint(8192 / 3)} // with non replay-protected votes 2/3 of the original vote-extension size are added.
