...
import (
	...
	"github.com/cometbft/cometbft/test/simulator/pkg/exec"
	"github.com/cometbft/cometbft/test/simulator/pkg/infra"
)
...
func (p Provider) StartNodes(ctx context.Context, nodes ...*e2e.Node) error {
	...
	return ExecCompose(ctx, p.Testnet.Dir, append([]string{"up", "-d", "prometheus"}, nodeNames...)...)
}
